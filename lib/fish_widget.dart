...
class FishPainter extends CustomPainter {
  ...
  static void drawFish(
    ...
    double tipTopX =
        tailX - tUx * (size.width * 0.1) + tNx * (size.height * 0.2);
    double tipTopY =
        tailY - tUy * (size.width * 0.1) + tNy * (size.height * 0.2);
    double tipBotX =
        tailX - tUx * (size.width * 0.1) - tNx * (size.height * 0.2);
    double tipBotY =
        tailY - tUy * (size.width * 0.1) - tNy * (size.height * 0.2);
    ...
    double finCtrlTopX =
        tailX - tUx * (size.width * 0.05) + tNx * (size.height * 0.15);
    double finCtrlTopY =
        tailY - tUy * (size.width * 0.05) + tNy * (size.height * 0.15);
    double finCtrlBotX =
        tailX - tUx * (size.width * 0.05) - tNx * (size.height * 0.15);
    double finCtrlBotY =
        tailY - tUy * (size.width * 0.05) - tNy * (size.height * 0.15);
    ...
    double finAttachTopX =
        headX - hUx * (size.width * 0.15) + hNx * (size.height * 0.12);
    double finAttachTopY =
        headY - hUy * (size.width * 0.15) + hNy * (size.height * 0.12);
    double finAttachBotX =
        headX - hUx * (size.width * 0.15) - hNx * (size.height * 0.12);
    double finAttachBotY =
        headY - hUy * (size.width * 0.15) - hNy * (size.height * 0.12);

    double leftFinTipX =
        finAttachTopX + hUx * (size.width * 0.05) + hNx * (size.height * 0.3);
    double leftFinTipY =
        finAttachTopY + hUy * (size.width * 0.05) + hNy * (size.height * 0.3);
    double leftFinCtrlX =
        finAttachTopX - hUx * (size.width * 0.1) + hNx * (size.height * 0.3);
    double leftFinCtrlY =
        finAttachTopY - hUy * (size.width * 0.1) + hNy * (size.height * 0.3);
    ...
    double rightFinTipX =
        finAttachBotX + hUx * (size.width * 0.05) - hNx * (size.height * 0.3);
    double rightFinTipY =
        finAttachBotY + hUy * (size.width * 0.05) - hNy * (size.height * 0.3);
    double rightFinCtrlX =
        finAttachBotX - hUx * (size.width * 0.1) - hNx * (size.height * 0.3);
    double rightFinCtrlY =
        finAttachBotY - hUy * (size.width * 0.1) - hNy * (size.height * 0.3);
